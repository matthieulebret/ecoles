...
fig = px.scatter_mapbox(df,lat='lat',lon='lon',hover_name='Ecole',color = 'Durée du programme',hover_data={'Note générale':True,'Salaire à la sortie, hors prime':True,'lat':False,'lon':False,'Moyenne au bac des nouveaux étudiants entrant à bac':':.2f','Moyenne au bac des nouveaux étudiants entrant à bac +2':':.2f','Pourcentage de mention TB au bac':':.2%',"Nombre total d'admis":':.2f','Prepa integree %':':.2%','CPGE %':':.2%','Admission parallele %':':.2%',"Nombre d'anciens sur Linkedin":True}
